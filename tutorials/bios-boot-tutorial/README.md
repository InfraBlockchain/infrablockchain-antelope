...
$ python3 bios-boot-tutorial.py --infra-cli="infra-cli --wallet-url http://127.0.0.1:6666 " --nodeos=nodeos --keystore=infra-keystore --contracts-dir="/EOSIO_CONTRACTS_DIRECTORY/" -a
