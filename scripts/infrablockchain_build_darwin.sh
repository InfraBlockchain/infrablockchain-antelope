...
[[ "${OS_MAX}" -eq 10 && "${OS_MIN}" -lt 14 ]] && echo "You must be running Mac OS 10.14.x or higher to install InfraBlockchain." && exit 1
...
ensure-brew-packages "${REPO_ROOT}/scripts/infrablockchain_build_darwin_deps"
