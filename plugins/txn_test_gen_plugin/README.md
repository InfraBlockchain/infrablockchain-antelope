...
$ ./infra-cli wallet import --private-key 5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3
$ ./infra-cli set contract eosio ~/eos/build.release/contracts/eosio.bios/ 
```
