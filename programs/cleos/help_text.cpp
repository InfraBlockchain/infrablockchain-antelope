...
You can check the contract's abi by using 'infra-cli get code' command.)=====";
...
If you are currently using 'infra-cli push action' command, try to add the relevant authority using -p option.)=====";
