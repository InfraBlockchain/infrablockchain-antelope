...
$YOSEMITE_CLI create account yosemite yx.tokenabi YOS7qFXz5bvLYphF8S8XXTYgExnN2hXRBSMHTXs8oartApBx5upR3 --txfee-payer yosemite
$YOSEMITE_CLI create account yosemite yx.txfee YOS7qFXz5bvLYphF8S8XXTYgExnN2hXRBSMHTXs8oartApBx5upR3 --txfee-payer yosemite
$YOSEMITE_CLI create account yosemite yx.msig YOS7qFXz5bvLYphF8S8XXTYgExnN2hXRBSMHTXs8oartApBx5upR3 --txfee-payer yosemite
$YOSEMITE_CLI create account yosemite yx.identity YOS7qFXz5bvLYphF8S8XXTYgExnN2hXRBSMHTXs8oartApBx5upR3 --txfee-payer yosemite
...
$YOSEMITE_CLI create account yosemite idauth.a YOS6EfGUaA5MNLH1GiHd64DcDr3HMgY1AM3WR1vdHKaah9Z4cWPZq --txfee-payer yosemite

$YOSEMITE_CLI wallet import --private-key YPV_5JRzPhyg9jY4thDJ1rLsSr4zdLLoA7UEMQRw3vJFGmGKTZF5Kbx
$YOSEMITE_CLI create account yosemite idauth.b YOS5VvWLCqXL3AQyuXZfUTnEiWuhJNV6Nq3YbbS7Z98cN7GiRo9LR --txfee-payer yosemite
...
$YOSEMITE_CLI create account yosemite systoken.a YOS6o8hwGio5V2LgBxFMZi4bdVG5AvcHeFiMpaREKuZ29BwXpNTpH --txfee-payer yosemite

$YOSEMITE_CLI wallet import --private-key YPV_5K5MBizJ6HuG1kdvQTeMnpKjpFSZHm64Nj3X6MvJR6AnTF8mHkx
$YOSEMITE_CLI create account yosemite systoken.b YOS61njg9Zs9oQmAmwLnrcVBrniWKshKAhoQJJqNVVnYXCPSRKLTE --txfee-payer yosemite
...
$YOSEMITE_CLI push action systoken.a settokenmeta '["2,DKRW","http://sysdepo-a.org","system depository a"]' -p systoken.a@active --txfee-payer yosemite

$YOSEMITE_CLI push action systoken.a issue '["systoken.a","systoken.a","100000.00 DKRW","issue systoken.a"]' -p systoken.a@active --txfee-payer yosemite

$YOSEMITE_CLI get token info systoken.a
$YOSEMITE_CLI get token balance systoken.a systoken.a

$YOSEMITE_CLI push action systoken.b settokenmeta '["2,DKRWB","http://sysdepo-b.org","system depository b"]' -p systoken.b@active --txfee-payer yosemite

$YOSEMITE_CLI push action systoken.b issue '["systoken.b","systoken.b","200000.00 DKRWB","issue systoken.b"]' -p systoken.b@active --txfee-payer yosemite
...
$YOSEMITE_CLI push action yosemite settxfee '["","",100000,1]' -p yosemite@active --txfee-payer yosemite
$YOSEMITE_CLI push action yosemite settxfee '["","issue",5000,1]' -p yosemite@active --txfee-payer yosemite
$YOSEMITE_CLI push action yosemite settxfee '["","transfer",10000,1]' -p yosemite@active --txfee-payer yosemite
$YOSEMITE_CLI push action yosemite settxfee '["","redeem",20000,1]' -p yosemite@active --txfee-payer yosemite
$YOSEMITE_CLI push action yosemite settxfee '["yosemite","newaccount",50000,1]' -p yosemite@active --txfee-payer yosemite

$YOSEMITE_CLI push action yosemite settxfee '["yx.identity","setidinfo",5000,1]' -p yosemite@active --txfee-payer yosemite
sleep 1
...
$YOSEMITE_CLI create account yosemite ysmt.dkrw YOS568YZYS8i2Gr6gbJE9CEEsyaZFfRXzVS9BNw9FfCLr9Yccpg7o --txfee-payer yosemite

sleep 2
$YOSEMITE_CLI set contract ysmt.dkrw $YOSEMITE_CONTRACTS_DIR/yosemitex.fiat.stable.token/ -p ysmt.dkrw@active --txfee-payer yosemite
sleep 2

$YOSEMITE_CLI push action ysmt.dkrw settokenmeta '["2,DKRW","https://yosemitex.com","Yosemite X Digital KRW Token"]' -p ysmt.dkrw@active --txfee-payer yosemite

$YOSEMITE_CLI push action yx.identity setidinfo "{\"account\":\"ysmt.dkrw\", \"identity_authority\":\"idauth.a\", \"type\":$(echo 'ibase=2; 0' | bc), \"kyc\":$(echo 'ibase=2; 1111' | bc), \"state\":$(echo 'ibase=2; 0' | bc), \"data\":\"ysmt.dkrw\"}" -p idauth.a@active --txfee-payer idauth.a
$YOSEMITE_CLI push action ysmt.dkrw issue '["ysmt.dkrw","ysmt.dkrw","10000000.00 DKRW",""]' -p ysmt.dkrw@active --txfee-payer yosemite

$YOSEMITE_CLI push action yosemite settxfee '["ysmt.dkrw","issue",0,1]' -p yosemite@active --txfee-payer yosemite
$YOSEMITE_CLI push action yosemite settxfee '["ysmt.dkrw","redeem",5000,1]' -p yosemite@active --txfee-payer yosemite

$YOSEMITE_CLI push action yosemite addsystoken '["ysmt.dkrw",10000]' -p yosemite@active --txfee-payer yosemite
...
$YOSEMITE_CLI push action systoken.a transfer '["systoken.a","idauth.a","idauth.b","5000.00 DKRW","transfer tag"]' -p idauth.a@active --txfee-payer idauth.a
$YOSEMITE_CLI push action systoken.a transfer '["systoken.a","idauth.a","idauth.b","3000.00 DKRW","transfer tag 2"]' -p idauth.a@active --txfee-payer idauth.b

$YOSEMITE_CLI get token balance systoken.a idauth.a
$YOSEMITE_CLI get token balance systoken.a idauth.b

$YOSEMITE_CLI get token balance systoken.a systoken.a
$YOSEMITE_CLI push action systoken.a redeem '["50000.00 DKRW","redeem tag"]' -p systoken.a@active --txfee-payer systoken.a
...
$YOSEMITE_CLI create account idauth.a useraccounta YOS7y8FkTHo58ZvrMa6yrTpo3D2Y2AA4dMAZzQ8aZY6R6geZSDZ75 --txfee-payer idauth.a
$YOSEMITE_CLI create account idauth.a useraccountb YOS8ZFsmfpevP8pKPMXuQMNB7P9KJoKzZwwzu2uww9VrRx7E7NUQj --txfee-payer idauth.a
$YOSEMITE_CLI create account idauth.a useraccountc YOS5ubmvsnjHviACtfc9SwGbY7SprqTu1P5GQeDfwfZmhCq6aR7GH --txfee-payer idauth.a
...
$YOSEMITE_CLI push action ysmt.dkrw issue '["ysmt.dkrw","useraccounta","5000000.00 DKRW",""]' -p ysmt.dkrw@active --txfee-payer ysmt.dkrw
$YOSEMITE_CLI push action ysmt.dkrw issue '["ysmt.dkrw","useraccountb","2000000.00 DKRW",""]' -p ysmt.dkrw@active --txfee-payer ysmt.dkrw
#$YOSEMITE_CLI push action ysmt.dkrw issue '["ysmt.dkrw","useraccountc","1000000.00 DKRW",""]' -p ysmt.dkrw@active --txfee-payer ysmt.dkrw

$YOSEMITE_CLI get token balance ysmt.dkrw useraccounta
$YOSEMITE_CLI get token balance ysmt.dkrw useraccountb

$YOSEMITE_CLI push action ysmt.dkrw transfer '["ysmt.dkrw","useraccounta","useraccountb","10000.00 DKRW","transfer tag"]' -p useraccounta@active --txfee-payer useraccounta


$YOSEMITE_CLI push action systoken.a issue '["systoken.a","useraccounta","100000.00 DKRW",""]' -p systoken.a@active --txfee-payer systoken.a
$YOSEMITE_CLI push action systoken.b issue '["systoken.b","useraccounta","100000.00 DKRWB",""]' -p systoken.b@active --txfee-payer systoken.b

$YOSEMITE_CLI push action systoken.a issue '["systoken.a","useraccountb","200000.00 DKRW",""]' -p systoken.a@active --txfee-payer systoken.a
$YOSEMITE_CLI push action systoken.a issue '["systoken.a","useraccountc","300000.00 DKRW",""]' -p systoken.a@active --txfee-payer systoken.a
...
$YOSEMITE_CLI push action systoken.a transfer '["systoken.a","useraccounta","useraccountb","99950.00 DKRW","transfer tag"]' -p useraccounta@active --txfee-payer useraccounta
...
$YOSEMITE_CLI create account yosemite ycardcredit YOS7mK7vvTTCDzEr8gtMjrMsbWA25UsS3WmV8WRoqC5gSMh9JLcQM --txfee-payer yosemite

sleep 2
$YOSEMITE_CLI set contract ycardcredit $YOSEMITE_CONTRACTS_DIR/yosemitex.credit.token/ -p ycardcredit@active --txfee-payer yosemite
sleep 2

$YOSEMITE_CLI push action ycardcredit settokenmeta '["2,CRD","https://yosemitecardx.com","Yosemite Card X Credit Token"]' -p ycardcredit@active -p yosemite@active --txfee-payer yosemite

$YOSEMITE_CLI push action yosemite settxfee '["ycardcredit","creditlimit",1000,1]' -p yosemite@active --txfee-payer yosemite
$YOSEMITE_CLI push action yosemite settxfee '["ycardcredit","creditissue",3000,1]' -p yosemite@active --txfee-payer yosemite
$YOSEMITE_CLI push action yosemite settxfee '["ycardcredit","creditredeem",5000,1]' -p yosemite@active --txfee-payer yosemite

$YOSEMITE_CLI push action yx.identity setidinfo "{\"account\":\"ycardcredit\", \"identity_authority\":\"idauth.a\", \"type\":$(echo 'ibase=2; 0' | bc), \"kyc\":$(echo 'ibase=2; 1111' | bc), \"state\":$(echo 'ibase=2; 0' | bc), \"data\":\"if3fhu3eu\"}" -p idauth.a@active --txfee-payer idauth.a
$YOSEMITE_CLI push action ysmt.dkrw issue '["ysmt.dkrw","ycardcredit","7000000.00 DKRW",""]' -p ysmt.dkrw@active --txfee-payer ysmt.dkrw

$YOSEMITE_CLI get token balance ysmt.dkrw ycardcredit

## issuing credit card to useraccounta by offering credit limit
$YOSEMITE_CLI push action ycardcredit creditlimit '["useraccounta","50000.00 CRD","vhw93rh23r"]' -p ycardcredit@active --txfee-payer ycardcredit
...
$YOSEMITE_CLI push action yosemite updateauth '{"account":"useraccounta","permission":"creditissue","parent":"active","auth":{"threshold":1,"keys":[],"waits":[],"accounts":[{"weight":1,"permission":{"actor":"ycardcredit","permission":"active"}}]}}' -p useraccounta@active --txfee-payer ycardcredit
$YOSEMITE_CLI push action yosemite linkauth '["useraccounta","ycardcredit","creditissue","creditissue"]' -p useraccounta@active --txfee-payer ycardcredit

$YOSEMITE_CLI push action ycardcredit creditissue '["useraccounta","ycardcredit","50000.00 CRD","issue credit token by user, and deposit to credit service"]' -p useraccounta@creditissue --txfee-payer ycardcredit
#$YOSEMITE_CLI push action ycardcredit transfer '["ycardcredit","useraccounta","ycardcredit","50000.00 CRD","deposit credit to service account for anonymous tx"]' -p useraccounta@active --txfee-payer ycardcredit
...
$YOSEMITE_CLI push action ycardcredit transfer '["ycardcredit","ycardcredit","useraccountb","10000.00 CRD","payment tx"]' -p ycardcredit@active --txfee-payer ycardcredit
$YOSEMITE_CLI push action ycardcredit transfer '["ycardcredit","ycardcredit","useraccountb","10000.00 CRD","payment tx"]' -p ycardcredit@active --txfee-payer ycardcredit

$YOSEMITE_CLI get token balance ycardcredit useraccountb

## monthly user credit balance settlement
$YOSEMITE_CLI push action ysmt.dkrw issue '["ysmt.dkrw","ycardcredit","20000.00 DKRW","useraccounta credit settlement"]' -p ysmt.dkrw@active --txfee-payer ysmt.dkrw

$YOSEMITE_CLI push action ycardcredit redeem '["30000.00 CRD","burn unused useraccounta credit"]' -p ycardcredit@active --txfee-payer ycardcredit

$YOSEMITE_CLI push action ycardcredit creditredeem '["useraccounta","50000.00 CRD","reset useraccounta credit offering"]' -p ycardcredit@active --txfee-payer ycardcredit

$YOSEMITE_CLI push action ycardcredit creditissue '["useraccounta","ycardcredit","50000.00 CRD","issue credit token by user, and deposit to credit service"]' -p useraccounta@creditissue --txfee-payer ycardcredit
#$YOSEMITE_CLI push action ycardcredit transfer '["ycardcredit","useraccounta","ycardcredit","50000.00 CRD","deposit credit to service account for anonymous tx"]' -p useraccounta@active --txfee-payer ycardcredit

## merchant(useraccountb) redeems credit tokens and withdraws fiat
$YOSEMITE_CLI push action ycardcredit transfer '["ycardcredit","useraccountb","ycardcredit","20000.00 CRD","request redeeming credit token"]' -p useraccountb@active --txfee-payer ycardcredit

$YOSEMITE_CLI push action ysmt.dkrw transfer '["ysmt.dkrw","ycardcredit","useraccountb","20000.00 DKRW","redeeming CRD to DKRW"]' -p ycardcredit@active --txfee-payer ycardcredit

$YOSEMITE_CLI push action ycardcredit redeem '["20000.00 CRD","burn redeemed credit tokens"]' -p ycardcredit@active --txfee-payer ycardcredit

$YOSEMITE_CLI get token balance ycardcredit useraccountb
$YOSEMITE_CLI get token balance ysmt.dkrw useraccountb

$YOSEMITE_CLI push action ysmt.dkrw transfer '["ysmt.dkrw","useraccountb","ysmt.dkrw","20000.00 DKRW","request redeeming DKRW to fiat"]' -p useraccountb@active --txfee-payer ycardcredit
$YOSEMITE_CLI push action ysmt.dkrw redeem '["20000.00 DKRW","redeem DKRW to fiat"]' -p ysmt.dkrw@active --txfee-payer ysmt.dkrw
