...
sleep 2
$YOSEMITE_CLI set contract yx.tokenabi $YOSEMITE_CONTRACTS_DIR/yx.tokenabi/ -p yx.tokenabi@active --fee-payer yosemite
sleep 2
...
sleep 2
$YOSEMITE_CLI set contract yx.msig $YOSEMITE_CONTRACTS_DIR/eosio.msig/ -p yx.msig@active --fee-payer yosemite
sleep 2
...
sleep 2
$YOSEMITE_CLI set contract yx.identity $YOSEMITE_CONTRACTS_DIR/yx.identity/ -p yx.identity@active --fee-payer yosemite
sleep 2


{ print_section_title "Register Initial Identity Authorities"; } 2>/dev/null

$YOSEMITE_CLI push action yosemite regidauth '["idauth.a","http://idauth-a.org",1]' -p idauth.a@active --fee-payer yosemite
$YOSEMITE_CLI push action yosemite authidauth '["idauth.a"]' -p yosemite@active --fee-payer yosemite

$YOSEMITE_CLI push action yosemite regidauth '["idauth.b","http://idauth-b.org",1]' -p idauth.b@active --fee-payer yosemite
...
$YOSEMITE_CLI push action systoken.a settokenmeta '["2,DKRW","http://sysdepo-a.org","system depository a"]' -p systoken.a@active --fee-payer yosemite

$YOSEMITE_CLI push action systoken.a issue '["systoken.a","systoken.a","100000.00 DKRW","issue systoken.a"]' -p systoken.a@active --fee-payer yosemite

$YOSEMITE_CLI get token info systoken.a
$YOSEMITE_CLI get token balance systoken.a systoken.a

$YOSEMITE_CLI push action systoken.b settokenmeta '["2,DKRWB","http://sysdepo-b.org","system depository b"]' -p systoken.b@active --fee-payer yosemite

$YOSEMITE_CLI push action systoken.b issue '["systoken.b","systoken.b","200000.00 DKRWB","issue systoken.b"]' -p systoken.b@active --fee-payer yosemite
...
$YOSEMITE_CLI push action yosemite settxfee '["","",100000,1]' -p yosemite@active --fee-payer yosemite
...
$YOSEMITE_CLI push action yosemite settxfee '["yx.identity","setidinfo",5000,1]' -p yosemite@active --fee-payer yosemite
sleep 1
$YOSEMITE_CLI get txfee list -L "yx.identity" -U "yx.identity"
$YOSEMITE_CLI push action yosemite unsettxfee '["yx.identity","setidinfo"]' -p yosemite@active --fee-payer yosemite
sleep 1
$YOSEMITE_CLI get txfee list -L "yx.identity" -U "yx.identity"
...
$YOSEMITE_CLI create account yosemite ysmt.dkrw YOS568YZYS8i2Gr6gbJE9CEEsyaZFfRXzVS9BNw9FfCLr9Yccpg7o --fee-payer yosemite

sleep 2
$YOSEMITE_CLI set contract ysmt.dkrw $YOSEMITE_CONTRACTS_DIR/yosemitex.fiat.stable.token/ -p ysmt.dkrw@active --fee-payer yosemite
sleep 2

$YOSEMITE_CLI push action ysmt.dkrw settokenmeta '["2,DKRW","https://yosemitex.com","Yosemite X Digital KRW Token"]' -p ysmt.dkrw@active --fee-payer yosemite
...
$YOSEMITE_CLI push action ysmt.dkrw issue '["ysmt.dkrw","ysmt.dkrw","10000000.00 DKRW",""]' -p ysmt.dkrw@active --fee-payer yosemite
...
$YOSEMITE_CLI push action systoken.a transfer '["systoken.a","idauth.a","idauth.b","3000.00 DKRW","transfer tag 2"]' -p idauth.a@active --fee-payer idauth.b
...
$YOSEMITE_CLI create account idauth.a useraccounta YOS7y8FkTHo58ZvrMa6yrTpo3D2Y2AA4dMAZzQ8aZY6R6geZSDZ75 --fee-payer idauth.a
$YOSEMITE_CLI create account idauth.a useraccountb YOS8ZFsmfpevP8pKPMXuQMNB7P9KJoKzZwwzu2uww9VrRx7E7NUQj --fee-payer idauth.a
$YOSEMITE_CLI create account idauth.a useraccountc YOS5ubmvsnjHviACtfc9SwGbY7SprqTu1P5GQeDfwfZmhCq6aR7GH --fee-payer idauth.a
...
$YOSEMITE_CLI create account yosemite ycardcredit YOS7mK7vvTTCDzEr8gtMjrMsbWA25UsS3WmV8WRoqC5gSMh9JLcQM --fee-payer yosemite

sleep 2
$YOSEMITE_CLI set contract ycardcredit $YOSEMITE_CONTRACTS_DIR/yosemitex.credit.token/ -p ycardcredit@active --fee-payer yosemite
sleep 2
...
$YOSEMITE_CLI push action yosemite updateauth '{"account":"useraccounta","permission":"creditissue","parent":"active","auth":{"threshold":1,"keys":[],"waits":[],"accounts":[{"weight":1,"permission":{"actor":"ycardcredit","permission":"active"}}]}}' -p useraccounta@active --fee-payer ycardcredit
$YOSEMITE_CLI push action yosemite linkauth '["useraccounta","ycardcredit","creditissue","creditissue"]' -p useraccounta@active --fee-payer ycardcredit

$YOSEMITE_CLI push action ycardcredit creditissue '["useraccounta","ycardcredit","50000.00 CRD","issue credit token by user, and deposit to credit service"]' -p useraccounta@creditissue --fee-payer ycardcredit
#$YOSEMITE_CLI push action ycardcredit transfer '["ycardcredit","useraccounta","ycardcredit","50000.00 CRD","deposit credit to service account for anonymous tx"]' -p useraccounta@active --fee-payer ycardcredit
...
$YOSEMITE_CLI push action ycardcredit transfer '["ycardcredit","useraccountb","ycardcredit","20000.00 CRD","request redeeming credit token"]' -p useraccountb@active --fee-payer ycardcredit
...
$YOSEMITE_CLI push action ysmt.dkrw transfer '["ysmt.dkrw","useraccountb","ysmt.dkrw","20000.00 DKRW","request redeeming DKRW to fiat"]' -p useraccountb@active --fee-payer ycardcredit
