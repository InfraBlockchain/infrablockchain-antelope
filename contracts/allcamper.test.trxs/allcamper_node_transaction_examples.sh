#!/usr/bin/env bash
# chmod +x ./allcamper_node_transaction_examples.sh
...
##################################
## AllCamper InfraBlockchain Node
curl -XPOST http://infrablockchain-explorer-api.allcamper.net:8888/v1/chain/get_token_balance -d '{"token":"akrw.token","account":"camperaaa113"}' | jq
curl -XPOST http://52.78.43.97:8888/v1/chain/get_token_balance -d '{"token":"akrw.token","account":"camperaaa113"}' | jq

##################################
## AllCamper InfraBlockchain Explorer

## AllCamper AKRW Token Contract
http://infrablockchain-explorer.allcamper.net/accounts/akrw.token

## AllCamper Trade/Rental Contract
http://infrablockchain-explorer.allcamper.net/accounts/allcamper

## AllCamper User Account
http://infrablockchain-explorer.allcamper.net/accounts/camperaaa111
