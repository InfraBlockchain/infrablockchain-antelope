...
/**
 *  @defgroup YOSEMITE System Token API
 *  @ingroup contractdev
 *  @brief Defines API for YOSEMITE System Token Operations
 */

/**
 *  @defgroup YOSEMITE System Token C API
 *  @ingroup systokenapi
 *  @brief Defines API for YOSEMITE System Token Operations
 *  @{
 */
 ...
 * @brief set the list of system tokens (vector<yosemite_system_token>) used as transaction fee payment token.
