...
namespace yosemite {
    ...
    public:
        ...
        static inline uint32_t get_kyc_authvector(const account_name &account, bool assert = true);
    };
    ...
    uint32_t kyc::get_kyc_authvector(const account_name &account, bool assert) {
