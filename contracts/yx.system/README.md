...
---
```bash
$YOSEMITE_CLEOS set contract yosemite $YOSEMITE_CONTRACTS_DIR/yx.system/ -p yosemite@active
```
...
$YOSEMITE_CLEOS create account yosemite sysdepo1 EOS7myk8qduMNnxo9Q9RZ2uxfaerQhXMPtxKUhxKh5HfSSM1dHeQo
...
$YOSEMITE_CLEOS create account yosemite sysdepo2 EOS62AXYcUxcSQQgKhnQ1oid2w1XNvCKxmPgk7C8fEi4FnQKhHLwM
```
...
$YOSEMITE_CLEOS create account yosemite idauth1 EOS5gFJS9EhjNpvcaGuDQqaeGQnNLuF9sWUt2s8surF1tRtSzLJiG
...
$YOSEMITE_CLEOS create account yosemite idauth2 EOS68JZEkVt4Z3dkrSmQ4SkH8XyVJVKTmnvawZyWcrxzhoH1WMp4Q
```

Register Initial Identity Authority
---
```bash
$YOSEMITE_CLEOS push action yosemite regidauth '["idauth1","http://idauth1.org",1]' -p idauth1@active -p yosemite@active
$YOSEMITE_CLEOS push action yosemite authidauth '["idauth1"]' -p yosemite@active

$YOSEMITE_CLEOS push action yosemite regidauth '["idauth2","http://idauth2.org",1]' -p idauth2@active -p yosemite@active
$YOSEMITE_CLEOS push action yosemite authidauth '["idauth2"]' -p yosemite@active

//$YOSEMITE_CLEOS push action yosemite rmvidauth '["idauth2"]' -p yosemite@active
```
...
```bash
$YOSEMITE_CLEOS get table yosemite yosemite idauthority
{
  "rows": [{
      "owner": "idauth1",
      "is_authorized": 1,
...
---
```bash
$YOSEMITE_CLEOS push action yosemite regsysdepo '["sysdepo1","http://sysdepo1.org",1]' -p sysdepo1@active -p yosemite@active
$YOSEMITE_CLEOS push action yosemite authsysdepo '["sysdepo1"]' -p yosemite@active

$YOSEMITE_CLEOS push action yosemite regsysdepo '["sysdepo2","http://sysdepo2.org",1]' -p sysdepo2@active -p yosemite@active
$YOSEMITE_CLEOS push action yosemite authsysdepo '["sysdepo2"]' -p yosemite@active
```
...
```bash
$YOSEMITE_CLEOS get table yosemite yosemite sysdepos
{
  "rows": [{
      "owner": "sysdepo1",
      "is_authorized": 1,
...
```bash
$YOSEMITE_CLEOS get table yosemite yosemite global
{
  "rows": [{
...
$YOSEMITE_CLEOS create account yosemite producer.a EOS6WZQdBdvfYre8akxVqCgp8SVYjrJRBnLqqpYGe7AXyJTTPYf4y -p yosemite@active
$YOSEMITE_CLEOS create account yosemite producer.b EOS79oucvH1iBTh5RrMgm6vRe9ERNSPQx4AiXGVctjmZQMkCkFrzS -p yosemite@active
$YOSEMITE_CLEOS create account yosemite producer.c EOS6FTViN9RtWd7B7RbERxcdhWSh2jmqiLkhMck315uSUwCsjeNHe -p yosemite@active
$YOSEMITE_CLEOS create account yosemite producer.d EOS66ABHVyT25wYUd2suW6JtbrwLrUdPFVDA1vjU8ttU289d2DPvJ -p yosemite@active
$YOSEMITE_CLEOS create account yosemite producer.e EOS8Ab5kDP22ta5FRmShTsZ4SZ3ubwptxzKWSBw7FtZLsew12SfrW -p yosemite@active
```

* register and authorize block producers (permissioned)

```bash
$YOSEMITE_CLEOS push action yosemite regproducer '["producer.a","EOS6WZQdBdvfYre8akxVqCgp8SVYjrJRBnLqqpYGe7AXyJTTPYf4y","http://producera.io",1]' -p producer.a@active -p yosemite@active
$YOSEMITE_CLEOS push action yosemite regproducer '["producer.b","EOS79oucvH1iBTh5RrMgm6vRe9ERNSPQx4AiXGVctjmZQMkCkFrzS","http://producerb.io",1]' -p producer.b@active -p yosemite@active

$YOSEMITE_CLEOS push action yosemite authproducer '["producer.a"]' -p yosemite@active
$YOSEMITE_CLEOS push action yosemite authproducer '["producer.b"]' -p yosemite@active
...
$YOSEMITE_CLEOS push action yosemite regproducer '["producer.c","EOS6FTViN9RtWd7B7RbERxcdhWSh2jmqiLkhMck315uSUwCsjeNHe","http://producerc.io",1]' -p producer.c@active -p yosemite@active
$YOSEMITE_CLEOS push action yosemite regproducer '["producer.d","EOS66ABHVyT25wYUd2suW6JtbrwLrUdPFVDA1vjU8ttU289d2DPvJ","http://producerd.io",1]' -p producer.d@active -p yosemite@active
$YOSEMITE_CLEOS push action yosemite regproducer '["producer.e","EOS8Ab5kDP22ta5FRmShTsZ4SZ3ubwptxzKWSBw7FtZLsew12SfrW","http://producere.io",1]' -p producer.e@active -p yosemite@active

$YOSEMITE_CLEOS push action yosemite authproducer '["producer.c"]' -p yosemite@active
$YOSEMITE_CLEOS push action yosemite authproducer '["producer.d"]' -p yosemite@active
$YOSEMITE_CLEOS push action yosemite authproducer '["producer.e"]' -p yosemite@active
...
---
```bash
$YOSEMITE_CLEOS get account yosemite
$YOSEMITE_CLEOS push action yosemite updateauth '{"account":"yosemite","permission":"owner","parent":"","auth":{"threshold":1,"keys":[],"waits":[],"accounts":[{"weight":1,"permission":{"actor":"yx.prods","permission":"active"}}]}}' -p yosemite@owner
$YOSEMITE_CLEOS push action yosemite updateauth '{"account":"yosemite","permission":"active","parent":"owner","auth":{"threshold":1,"keys":[],"waits":[],"accounts":[{"weight":1,"permission":{"actor":"yx.prods","permission":"active"}}]}}' -p yosemite@active
$YOSEMITE_CLEOS get account yosemite

$YOSEMITE_CLEOS get account yx.prods
permissions: 
     owner     1:    
...
---
```bash
$YOSEMITE_CLEOS push action -j -d yosemite rmvproducer '["producer.e"]' -p yosemite@active
#$YOSEMITE_CLEOS push action yosemite rmvproducer '["producer.e"]' -p yosemite@active
#$YOSEMITE_CLEOS push action yosemite rmvproducer '["producer.d"]' -p yosemite@active
$YOSEMITE_CLEOS get account yx.prods
```
...
$YOSEMITE_CLEOS push action yosemite claimrewards '["producer.c"]' -p producer.c@active
...
$YOSEMITE_CLEOS get table eosio yosemite producers
...
$YOSEMITE_CLEOS create account yosemite com EOS584bQn471vv2q7N1xeDXayfDtiim8kPsNm45TRuJ9D51YPFFmX -p yosemite@active
...
```bash
$YOSEMITE_CLEOS push action yosemite setpriv '["yx.ntoken",1]' -p yosemite@active
```
