...
const static uint64_t system_account_name    = N(yosemite);
const static uint64_t null_account_name      = N(yx.null);
const static uint64_t producers_account_name = N(yx.prods);
...
const static uint64_t eosio_auth_scope       = N(yx.auth);
const static uint64_t eosio_all_scope        = N(yx.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t eosio_any_name = N(yx.any);
const static uint64_t eosio_code_name = N(yx.code);
