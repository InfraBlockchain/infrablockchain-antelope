/**
 *  @file infrablockchain/chain/standard_token_database.hpp
...
CHAINBASE_SET_INDEX_TYPE(infrablockchain::chain::token_meta_object, infrablockchain::chain::token_info_multi_index)
