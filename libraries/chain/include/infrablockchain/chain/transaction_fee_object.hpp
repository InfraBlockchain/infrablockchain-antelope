/**
 *  @file infrablockchain/chain/transaction_fee_object.hpp
...
namespace infrablockchain { namespace chain {
   ...
   const static name code_name_for_built_in_actions{ 0 };
   const static name code_name_for_default_tx_fee{ 0 };
   const static name action_name_for_default_tx_fee{ 0 };
    ...
    */
   class transaction_fee_object : public chainbase::object<infrablockchain_transaction_fee_object_type, transaction_fee_object> {
...
CHAINBASE_SET_INDEX_TYPE(infrablockchain::chain::transaction_fee_object, infrablockchain::chain::transaction_fee_table_multi_index)

FC_REFLECT(infrablockchain::chain::transaction_fee_object, (code)(action)(value)(fee_type) )
