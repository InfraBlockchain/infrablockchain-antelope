/**
 *  @file infrablockchain/chain/transaction_fee_database.hpp
...
CHAINBASE_SET_INDEX_TYPE(infrablockchain::chain::transaction_fee_object, infrablockchain::chain::transaction_fee_multi_index)
